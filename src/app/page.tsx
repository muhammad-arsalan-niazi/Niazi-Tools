          ...
          {activeTool === null ? (
            <>
              ...
              <div className="relative w-full mb-24 pt-12 pb-16 flex flex-col items-center text-center animate-in fade-in slide-in-from-bottom-8 duration-1000">
                ...
                <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full max-w-2xl h-64 bg-primary/20 blur-[100px] rounded-full -z-10 pointer-events-none opacity-50 dark:opacity-30 animate-pulse"></div>
                
                {/* Decorative moving bubbles */}
                <div className="absolute top-10 left-[10%] w-24 h-24 bg-fuchsia-500/20 rounded-full blur-xl -z-10 pointer-events-none animate-bounce" style={{ animationDuration: '4s' }}></div>
                ...
                <div className="absolute top-20 right-[25%] w-16 h-16 bg-primary/30 rounded-full blur-lg -z-10 pointer-events-none animate-bounce" style={{ animationDuration: '3s' }}></div>
